...
명령어 : siege -c5 -t10S -v --content-type "application/json" 'http://{aws_url}.elb.amazonaws.com:8080/members POST {"inquiryStatus":"CANCEL"}'
...
```
부하테스터 siege 툴을 통한 서킷 브레이커 동작 결과
